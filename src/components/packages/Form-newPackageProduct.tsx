...
export const FormNewPackageProduct: React.FC<FormNewPackageProductProps> = ({ addProduct }) => {
    ...
    const [products] = useState<Product[]>([
        ...
        { id: "2", name: "Pepsi", price: 4.5 },
        { id: "3", name: "Guaraná", price: 4.0 },
        { id: "4", name: "Água Mineral", price: 2.0 },
        { id: "5", name: "Suco de Laranja", price: 6.0 },
        { id: "6", name: "Chá Gelado", price: 3.5 },
        { id: "7", name: "Energético", price: 8.0 },
    ]);
